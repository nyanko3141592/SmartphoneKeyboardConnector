...
- \*\*や行の左（o）\*\*は小書きのショートカットに割当（`o=ゃ`）。
  “大 ⇔ 小”が有効なら中央/上/右も **ゃ/ゅ/ょ** を出せます。
...
```json
{
  ...
  "keys": [
...

    {
      ...
      "col": 2,
      "label": "や",
      "flick": { "a": "や", "i": "ゆ", "u": "よ", "e": null, "o": "ゃ" },
      "smallMode": { "a": "ゃ", "i": "ゅ", "u": "ょ" },
      "yoonSource": true
    },
...
onKeyGesture(keyId, direction):
  ...
  // YAキー特例（小書き直出し）
  if keyId == YA and (direction in {center, up, right}) and smallOneShot:
     ch = {"center":"ゃ","up":"ゅ","right":"ょ"}[direction]
     smallOneShot = false
